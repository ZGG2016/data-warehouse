package org.zgg.gmall.realtime.util
...
object MyKafkaUtils {
  ...
  private val consumerConfigs: mutable.Map[String, Object] = mutable.Map[String, Object](
    // kafka集群位置
//    ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG -> "bigdata102:9092",
//    ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG -> MyPropsUtils("kafka.bootstrap-servers"),
  ...
  /**
   * 基于sparkstreaming消费，获取kafkaDStram，使用默认的offset
   */
  ...
  def createProducer(): KafkaProducer[String, String] = {
    ...
    //kafka集群位置
//    producerConfigs.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "bigdata102:9092")
